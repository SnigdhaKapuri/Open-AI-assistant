...
class LoginScreen(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Welcome to Jarvis Login")
        self.setFixedSize(450, 300)  # Increased size
        self.setStyleSheet("""
        ...
        # Title
        title = QLabel(f"Welcome to {Assistantname}")
        title.setFont(QFont("Arial", 20, QFont.Bold))  # Slightly bigger font
    ...
    def check_credentials(self):
        ...
        if username in credentials and credentials[username] == password:
            ...
            success_message = f"Welcome back, {username}!\nYou're now successfully logged in."

        # Creating a custom QMessageBox
            success_box = QMessageBox(self)
            success_box.setIcon(QMessageBox.Information)
            success_box.setWindowTitle(f"Welcome {username}!")
        ...
        # Style customization
            ...
            success_box.button(QMessageBox.Ok).setStyleSheet("""
                background-color: #03DAC5;
                color: black;
                border-radius: 10px;
                padding: 10px;
...
class MessageScreen(QWidget):
    def __init__(self, parent=None):
        ...
        pixmap = QPixmap(GraphicsDirectoryPath('Mic_off.png'))  # Or Mic_on.png
        new_pixmap = pixmap.scaled(40, 40)
        self.icon_label.setPixmap(new_pixmap)
        self.icon_label.setFixedSize(50, 50)
        self.icon_label.setStyleSheet("""
